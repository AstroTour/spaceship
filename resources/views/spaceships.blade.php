    ...
    <div class="information">
        ...
        <form action="{{ route('spaceships.create') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control date-picker" style="color: white" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea name="information" id="information" class="form-control date-picker" style="color: white">{{ old('information') }}</textarea>
                @error('information')
                    <div class="alert alert-danger">A mező kitöltése kötelező</div>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="number" name="capacity" id="capacity" class="form-control date-picker" style="color: white" value="{{ old('capacity') }}">
                @error('capacity')
